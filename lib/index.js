(function() {
  ...
  getProperty = function(propName, properties, inFallback) {
    var res, tmp;
    tmp = propName.split('.');
    res = properties;
  ...
  handleUndefined = function(propName, inFallback) {
  ...
  replaceProperties = function(content, properties, lv, inFallback) {
    lv = lv || 1;
